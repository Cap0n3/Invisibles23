"""
Django settings for Invisibles23 project.
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "libraries": {
                "my_templatetags": "templatetags.my_templatetags",
            },
        },
    },
]

WSGI_APPLICATION = "Invisibles23.wsgi.application"
...
CKEDITOR_CONFIGS = {
    "default": {
        # This is the name of the skin for the rich text editor interface (see customReadme.md)
        "skin": "moono-dark",
    }
}
